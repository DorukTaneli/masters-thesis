...
\hline
\textbf{Dataset name} & \textbf{Boat}              & \textbf{\begin{tabular}[c]{@{}l@{}}Original\\Length(h)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Cleaned\\Length(h)\end{tabular}} & \textbf{Tack Detection} \\ \hline
RDR                   & \multirow{3}{*}{Concise 8} & 16                                                                     & 16                                                                   & $\ballotx$                      \\ \cline{1-1} \cline{3-5} 
DHREAM 18             &                            & 64.5                                                                   & 64.5                                                                 & $\ballotx$                      \\ \cline{1-1} \cline{3-5} 
Atlantic              &                            & 290.9                                                                  & 228.7                                                                & $\ballotcheck$                     \\ \hline
DHREAM 20             & VMB                        & 7                                                                      & 6                                                                    & $\ballotx$                      \\ \hline
transat\_1            & Unknown 1                  & 383.5                                                                  & 63.3                                                                 & $\ballotx$                      \\ \hline
\end{tabular}
...
\begin{comment}
\subsection*{Timeline}
It is important to stay flexible due to mentioned obstacles, and iterate according to feedback of the supervisors. A tentative timeline has been created, which can be found in appendix \ref{}, at the very end of this report.
\end{comment}
