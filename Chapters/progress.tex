...
\begin{figure}[h]
\centering
\includegraphics[width = 0.5\hsize]{figures/rl-framework/hyperparameter-ddpg.png}
\caption{Performance of DDPG on Walker2d-v1 with random hyperparameters \cite{hyperparameter-ddpg}}
