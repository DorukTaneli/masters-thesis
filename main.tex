...
\end{tabular}
\caption{Charles' best performing models vs new optimized models: Part 1}
\label{tab:opt-model-p1}
\end{table}
...
\end{tabular}
\caption{Charles' best performing models vs new optimized models: Part 2}
\label{tab:opt-model-p2}
\end{table}
