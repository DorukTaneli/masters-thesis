...
\section{Entities Involved in the Project}
...
In this section, the modern Reinforcement Learning algorithms and the suggested algorithm to be used in the Reinforcement Learning approach is discussed.

\subsection{Reinforcement Learning Algorithms} \label{LR:RL}

In this section, Reinforcement Learning algorithms that might be used in the reinforcement learning approach will be discussed.
...
\begin{figure}[h]
\centering
\includegraphics[width = 0.8\hsize]{figures/Birk Ulstad LSTM prediction.png}
...
\begin{figure}[h]
\centering
\includegraphics[width = 0.75\hsize]{figures/roman data flow.png}
...
\begin{figure}[h]
\centering
\includegraphics[width = \hsize]{figures/stan results.png}
...
\begin{table}[h]
\centering
\includegraphics[width=0.8\linewidth]{figures/charles results.png}
\caption{Charles' error rates for different prediction methods}
