...
\section{Evaluation}
As explained in the Outcomes section of the Introduction, this project was successful in many of the goals that were set to achieve.
...
To use the models in a RL setting, the models need to be able to make accurate and realistic predictions from previously predicted values.
